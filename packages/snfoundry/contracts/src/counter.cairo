...
pub mod CounterContract {
    ...
    impl CounterImpl of ICounter<ContractState> {
        ...
        fn reset_counter(ref self: ContractState) {
            ...
            let dispacher = IERC20Dispatcher{contract_address: stark_token};
            ...
            let sucess = dispacher.transfer_from(caller, owner, payment_amount);
            assert!(sucess, "Transfering STRK failed");
